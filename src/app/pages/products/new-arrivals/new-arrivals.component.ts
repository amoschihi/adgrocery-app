...
export class NewArrivalsComponent implements OnInit {
  ...
  ngOnInit() {
    this.screenService.isLargPc.subscribe(value => {
      if (value) {
        ...
        if (this.products.length < 6 && this.productPaginate.total >= 6) {
          this.productService.getNewArrival(1, this.productPaginate.per_page, true).subscribe(value1 => {
    ...
    this.productService.getNewArrival(1, this.productPaginate.per_page).subscribe(value => {
  ...
  prev() {
    this.productService.getNewArrival(1, this.productPaginate.per_page, true, this.productPaginate.prev_page_url).subscribe(value => {
      this.products = value.data;
      this.productPaginate = value;
  ...
  next() {
    this.productService.getNewArrival(1, this.productPaginate.per_page, true, this.productPaginate.next_page_url).subscribe(value => {
      this.products = value.data;
      this.productPaginate = value;
    });
  }
